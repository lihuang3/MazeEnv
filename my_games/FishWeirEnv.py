...
class FishWeirEnv(core.Env):
    ...
    def get_reward(self):
        ...
        if max_cost_agent <= self.goal_range:
          ...
          reward = 1
        elif max_cost_agent <= 13 * self.goal_range and not self.reward_grad[11]:
