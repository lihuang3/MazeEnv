...
if __name__ == '__main__':
    ...
    parser.add_argument('--env', type=str, default='Maze0524Env4')
    parser.add_argument('--nsteps', type=int, default=360)
    parser.add_argument('--nepisodes', type=int, default=128)
    parser.add_argument('--weights', type=lambda s:[int(item) for item in s.split(',')], default='8, 4, 2, 8,1')

    # [4, 1, 1, 8, 1], [8, 1, 1, 8, 1]
    # mean = 15.52, std = 2.41 trials=128
    # basemean = 2.76, std = 0.92
