...
class Maze1203Env2(core.Env):
    ...
    def _load_data(self, data_directory):
        mazeData = np.loadtxt(data_directory + '/map1203.csv').astype(int)
        freespace = np.loadtxt(data_directory + '/map1203_freespace.csv').astype(int)
        costData = np.loadtxt(data_directory + '/map1203_costmap.csv').astype(int)
