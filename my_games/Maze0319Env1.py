...
class Maze0319Env1(core.Env):
    def __init__(self):
        ...
        self.action_map = {0: (0, 1), 1: (1, 0), 2: (0, -1), 3: (-1, 0)}  # {up, right, down, left}
        self.rev_action_map = {(0, 1): 0, (1, 0): 1, (0, -1): 2, (-1, 0): 3 }
