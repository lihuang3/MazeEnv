            ...
            for wk in weight_dict:
                ...
                for i in range(episode):
                    ...
                    while not done:
                        ...
                        _, _, done, _ =env._step(next_action)
                        # env.render()
                        ...
                        if done:
                            steps = 0
                            env.reset()
                print('deli mean = ', np.mean(delivery), 'deli std = ', np.std(delivery))
